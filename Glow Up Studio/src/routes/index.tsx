  ...
  head: () => ({
    meta: [
      { title: "Maltadigital — Marketing Digital para Salões de Beleza" },
      {
        name: "description",
        content:
          "Colocamos o teu salão de beleza, barbearia ou clínica de estética no topo do Google. Google Meu Negócio, SEO Local e sites que transformam pesquisas em agendamentos.",
      },
      { property: "og:title", content: "Maltadigital — Marketing para Salões" },
      {
        property: "og:description",
        content: "Menos promessas. Mais agendamentos. Posicionamento local para o teu salão.",
      },
